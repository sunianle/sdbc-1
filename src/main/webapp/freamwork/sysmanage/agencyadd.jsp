...
<script type="text/javascript">
	function check(form) {
		...
		if (form.bankIp.value == '') {
			alert("请输入银行IP!");
			form.bankIp.focus();
			return false;
		}
		if (form.connName.value == '') {
			alert("请输入银行联系人!");
			form.connName.focus();
			return false;
		}
		if (form.connPhone.value == '') {
			alert("请输入银行联系人电话!");
			form.connPhone.focus();
			return false;
		}
		...
		xmlhttp.open("POST", "../sm/unique_bank_id?bank_id=" + bank_id, true);
...
<body>
	<div class="panel panel-default bk-bg-white">
		<div class="panel-heading bk-bg-white">
			<h6>
				<i class="fa fa-table red"></i><span class="break"></span>新增机构
			</h6>
			</div>
			<div class="panel-body">
				<form id="form" action="insertAgency" method="post"
					class="form-horizontal " onsubmit="return check(this)">
					<div class="form-group">
						<label class="col-sm-3 control-label" for="input-normal">银行编号</label>
						<div class="col-sm-6">
							<input type="text" id="bankId" name="bankId"
								class="form-control" placeholder="银行编号" maxlength="30"
								/>
						</div>
					</div>
						<div class="form-group">
						<label class="col-sm-3 control-label" for="input-normal">银行名称</label>
						<div class="col-sm-6">
							<input type="text" id="bankName" name="bankName"
								class="form-control" placeholder="银行名称" maxlength="30" />
						</div>
					</div>
						<div class="form-group">
						<label class="col-sm-3 control-label" for="input-normal">银行IP</label>
						<div class="col-sm-6">
							<input type="text" id="bankIp" name="bankIp"
								class="form-control" placeholder="银行IP" maxlength="30" />
						</div>
					</div>
						<div class="form-group">
						<label class="col-sm-3 control-label" for="input-normal">银行联系人</label>
						<div class="col-sm-6">
							<input type="text" id="connName" name="connName"
								class="form-control" placeholder="银行联系人" maxlength="30" />
						</div>
					</div>
						<div class="form-group">
						<label class="col-sm-3 control-label" for="input-normal">联系人电话</label>
						<div class="col-sm-6">
							<input type="text" id="connPhone" name="connPhone"
								class="form-control" placeholder="联系人电话" maxlength="30" />
						</div>
					</div>
					<div class="form-group">
