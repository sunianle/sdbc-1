	...
	<div class="container-fluid content">
		<div class="row">
			...
			<div class="panel-heading">
				<h6>
					<i class="fa fa-indent red"></i>汇总与报表<a
						href="../rb/report"><span
			...
			<div class="col-sm-12">
						<div class="col-sm-3">
							银行名称：<input type="text" id="args1" value="${args1}">
						</div>
						<div class="col-sm-3">
							流&nbsp;&nbsp;水&nbsp;&nbsp;号：<input type="text" id="args2" value="${args2}">
						</div>
						<div class="col-sm-3">
							业务类型：<SELECT id="args3">
								<OPTION value="all">全部</OPTION>
								<OPTION value="loan">借款</OPTION>
								<OPTION value="cut">还款</OPTION>
							</SELECT>
						</div>
					</div>
