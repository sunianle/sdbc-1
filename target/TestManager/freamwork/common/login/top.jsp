...
<body>
    <div class="top">
      <div id="top_t">
        <div id="logo" class="fl"><img src="${pageContext.request.contextPath }/images/logo.png"></img></div>
        <div id="photo_info" class="fr" >
           
          <div id="photo" class="fl" align="left">
          ...
          <div id="base_info" class="fr">                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   
           ...
           <img src="../../images/user.png"></img>
            ${sessionScope.user}
              ...
              <a href="${pageContext.request.contextPath }/mc/user/login" style="color: white;">退出</a>
            </div>  
          </div> 
        </div>
      </div>
